...
/**
 * The GameOverScreen class represents the screen that is displayed when the game is over.
...
public class GameOverScreen implements Screen {
     ...
     * 
     * @param game The instance of the KingsSaga game.
     */
    public GameOverScreen(final KingsSaga game) {
        this.game = game;
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, "Game Over!", xPos, yPos,
